    ...
    <div>
      ...
      <section className="min-h-[85vh] bg-gradient-to-br from-blue-600 to-purple-700 flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/target-audience" className="bg-white text-blue-600 px-8 py-3.5 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-lg">
              Learn More
            </Link>
            <Link href="/contact" className="border-2 border-white text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-white/10 transition-colors text-lg">
              Get in Touch
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/target-audience" className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow group">
              ...
              <p className="text-gray-500 text-sm">Learn more about our target audience.</p>
            </Link>
            <Link href="/structure" className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow group">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-200 transition-colors">
                <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Structure</h3>
              <p className="text-gray-500 text-sm">Learn more about our structure.</p>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <Link href="/contact" className="inline-block bg-white text-blue-600 px-10 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-lg">
            Contact Us Today
          </Link>
        </div>
      </section>
